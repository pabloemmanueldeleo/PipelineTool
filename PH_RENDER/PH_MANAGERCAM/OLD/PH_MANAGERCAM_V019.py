...
def makeWindow():
    ...
    rl3=cmds.rowLayout( parent=cl2,numberOfColumns=2,columnAlign=(1, 'right'))
    ...
    b3=cmds.button(parent=rl2, label='CREAR SEQ', bgc=(0.3,0.7,1),annotation='Crea Secuencia con las camaras de la escena.' )
    b3a=cmds.button(parent=rl2, label='SHOW', bgc=(0.3,0.7,1),annotation='Muestra la ventana de Camera Sequencer.' )
    b4=cmds.button(parent=rl2, label='IMPORTCAM',  bgc=(0.9,0.5,0.0) ,annotation='Seleciona la camara la cual remplazar para importar el rig nuevo.\n*La Camara de pampa tiene que tener este nombre para importar UD??_E???_P??_CAM')
    b5=cmds.button(parent=rl2, label='ACTUALIZAR', bgc=(0.5,0.2,0.0) ,annotation='Si hay algun cambio de camaras, es neceasrio actualizar.')
