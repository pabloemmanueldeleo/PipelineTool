...
def upRig():
    mel.eval('source "D:/PH_SCRIPTS/PH_RENDER/PH_MANAGERCAM/PH_UPDATERIG.mel"')
########Mangager Camaras#########
def selectChanged():
...
def makeWindow():
    ...
    b3=mc.button(parent=cl6, label='CREAR SEQ', command="PH_MANAGERCAM.cameraShow()",bgc=(0.3,0.7,1),annotation='-Crea Secuencia con las camaras de la escena.\nTiene que tener key los controles si o si.' )
