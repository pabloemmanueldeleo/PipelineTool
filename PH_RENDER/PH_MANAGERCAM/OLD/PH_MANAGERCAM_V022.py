...
def makeWindow():
    ...
    rl3=mc.rowLayout( parent=cl2,numberOfColumns=3,columnAlign=(3, 'center'))
    ...
    cl3=mc.columnLayout(parent=cl2,adjustableColumn = True)
    tx5=mc.text(parent=cl3,label='\nEXTRA TOOLS\n',font='boldLabelFont')
    rl2=mc.rowLayout( parent=cl3,numberOfColumns=3)
    cl4=mc.columnLayout(parent=rl2,adjustableColumn = True)
    ...
    b4=mc.button(parent=cl4, label='PLAYBLAST', command="PH_MANAGERCAM.playBlastShot()", bgc=(0.1,0.5,0.0) ,annotation='Crea en tu directorio de escena un preview con los datos necesarios, con los frames que le das.')
    cl5=mc.columnLayout(parent=rl2,adjustableColumn = True)
    ...
    cl6=mc.columnLayout(parent=rl2,adjustableColumn = True)
    ...
    cl7=mc.columnLayout(parent=cl3,adjustableColumn = True)
