...
def makeWindow():
    ...
    bBake = mc.button(parent=cl5, label='BAKE', w=60 , command="PH_MANAGERCAM.bakeCamGrp()", bgc=(1,0,0),annotation='-Bakea y exporta R y L de grupo\s seleccionados. Usa el cameraSequencer para obtener el intervalo a bakear.')
    ...
    b0a=mc.button(parent=cl5b, label='LOCK PRO',  w=60 , command="PH_MANAGERCAM.lockcamsprop()", bgc=(0.7,0.2,0.1),annotation='-Desbloquea y bloquea seteos de camaras.\nIMPORTANTE: Primero hablar con Diego.')
