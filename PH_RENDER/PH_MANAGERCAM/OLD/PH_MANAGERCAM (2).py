...
def newCam():#crea una camara comun
    ...
    p=mc.intFieldGrp (pla, q = True , value1=True)
...
def makeWindow():
    ...
    pla=mc.intFieldGrp(parent=cl6, numberOfFields=1, columnAlign2=['left','right'],columnWidth2=[40,30], label='PLANO', value1=00 )
    #Columna informacion
