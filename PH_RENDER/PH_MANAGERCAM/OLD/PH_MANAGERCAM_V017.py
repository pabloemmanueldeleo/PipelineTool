...
def makeWindow():
    ...
    cmds.window( winName,title=winName+version,s=1)
    fl1=cmds.formLayout( parent = winName )
    rl1=cmds.rowLayout( numberOfColumns=3,columnWidth3=(200, 10, 50),columnAlign3=["left", "center", "center"])
    ...
    tslBOX=cmds.textScrollList(camListBox, parent=cl2, allowMultiSelection=False, selectCommand="selectChanged()",h=200)
    ...
    sc1=cmds.dockControl( area='left', content=fl1, allowedArea=allowedAreas)
    #cmds.showWindow()
