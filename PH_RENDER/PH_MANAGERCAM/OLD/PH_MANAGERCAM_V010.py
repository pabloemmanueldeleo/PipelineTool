...
def initGui():
    ...
    trfCams = cmds.ls('SCAM*_E*_P*','C_E*_P*',type='transform')
...
def makeWindow():
    ...
    tslTRF=cmds.textScrollList(camListTrf,parent=cl1, deleteKeyCommand="delSelected()", allowMultiSelection=False, selectCommand="selectTrf()",h=350)
