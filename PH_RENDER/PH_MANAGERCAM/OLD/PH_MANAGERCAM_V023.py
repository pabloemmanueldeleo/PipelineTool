...
def makeWindow():
    ...
    rl3=mc.rowLayout( parent=cl2,numberOfColumns=4,columnWidth4=(100, 50, 50,50))
    ...
    #Extra
    cl3=mc.columnLayout(parent=cl1)
    tx5=mc.text(parent=cl3,label='\n-EXTRA TOOLS-\n',font='boldLabelFont')
    rl2=mc.rowLayout( parent=cl3,numberOfColumns=3,columnWidth3=(80, 80, 80),columnAttach3=("left","both",'right'))
    cl4=mc.columnLayout(parent=rl2)
    ...
    b8=mc.button(parent=cl4, label='UPDATERIG', command="PH_MANAGERCAM.updateRig()", bgc=(0.9,0.5,0.0) ,annotation='-Remplaza rigCamaras viejos por nuevos.\nEj: SCAM_ y _control')        
    cl5=mc.columnLayout(parent=rl2)
    ...
    cl6=mc.columnLayout(parent=rl2)
