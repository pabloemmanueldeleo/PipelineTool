...
def makeWindow():
    ...
    rl3=mc.rowLayout( parent=cl2,numberOfColumns=4,adjustableColumn3=4)
    ...
    pla=mc.textFieldGrp(parent=cl6, columnAlign2=['left','right'],columnWidth2=[40,30], label='PLANO' , text = '00a')
    #Columna informacion
