...
# 05/08 : copia aperturas de camara
# 10/08 : deslockea antes de ver si la cam tiene keys.
...
def cam2stereoMain ():
    ...
    for cam in objetosSeleccionados:
        cmds.setAttr ( (cam+".tx") , l=0 )
        cmds.setAttr ( (cam+".ty") , l=0 )
        cmds.setAttr ( (cam+".tz") , l=0 )
        cmds.setAttr ( (cam+".rx") , l=0 )
        cmds.setAttr ( (cam+".ry") , l=0 )
        cmds.setAttr ( (cam+".rz") , l=0 )
        cmds.setAttr ( (cam+".v") , l=0 )
        cmds.setAttr ( (cam+".fl") , l=0 )
                    ...
                    if objetosSeleccionados[i] != 'top':
                        if objetosSeleccionados[i] != 'side':
                            if objetosSeleccionados[i] != 'persp':
                                ...
                                checkTR=0
                                checkS=1
                                EXXX_PXX = (objetosSeleccionados[indexSel] [5: len ( objetosSeleccionados[indexSel] )-4 ]).upper()
                                ...
                                if ( (checkTR==0) and (checkS==1) ) or ( len (padresDeSelSplitEditado)==0):
                                    ...
                                    hA = cmds.camera ( objetosSeleccionados[indexSel] , q=True , hfa=True )
                                    vA = cmds.camera ( objetosSeleccionados[indexSel] , q=True , vfa=True )

                                    cmds.setAttr ( "C_E999_P00__CNT.FocalLenght", focalLength )
                                    cmds.setAttr ( "L_E999_P00__CAMSH.horizontalFilmAperture", hA )
                                    cmds.setAttr ( "L_E999_P00__CAMSH.verticalFilmAperture", vA )
                                    cmds.setAttr ( "R_E999_P00__CAMSH.horizontalFilmAperture", hA )
                                    cmds.setAttr ( "R_E999_P00__CAMSH.verticalFilmAperture", vA )
