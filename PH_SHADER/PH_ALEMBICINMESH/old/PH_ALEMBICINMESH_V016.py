...
def _makeWindow():
    ...
    cmds.button( label='REFRESH', command=".PH_ALEMBICINMESH_refreshGui()", bgc=(0.1,0.5,0.1))
    cmds.button( label='TRANFER ALEMBIC', command=".PH_ALEMBICINMESH_startTranfer()", bgc=(0.1,0.5,0.1))
    cmds.showWindow()
    #inicio la lista
    _initGui()