...
def UIprotoloco():
	...
	mc.button(parent=buttonForm, label='TimeRange', command='_rangeTimeLine()',bgc=(0.1,0.8,0.0))
	mc.button(parent=buttonForm, label='Protocolo KEY 0', command='_protocolo0Key()',w=100,h=20,bgc=(1.0,0.4,0.0) )
	mc.button(parent=buttonForm, label='Protocolo KEY 60', command='_protocolo60Key()',bgc=(1.0,0.5,0.0),visible=0 )
