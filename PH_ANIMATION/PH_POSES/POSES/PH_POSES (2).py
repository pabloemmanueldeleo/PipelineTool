...
def posesMain():
	...
	mc.dockControl( 'dockPosesUI' , label= "POSES v1.0",area='left', content='posesUI', allowedArea=allowedAreas )

def creaLayout(parentL=""):
	posesEnM = mc.getFileList( folder="M:\PH_SCRIPTS\ICONS\POSES", filespec='*.png' )
	posesEnM.sort()
	indice=0
