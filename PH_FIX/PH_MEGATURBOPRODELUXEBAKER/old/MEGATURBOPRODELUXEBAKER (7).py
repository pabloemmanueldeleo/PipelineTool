...
def bakearGUI():
	...
	mc.warning ("MegaTurboProDeluxe BAKER v1.2 . SE EXPORTARA A D:\EXPORT")
		...
		if len(canalesParaBake) !=0 :
			...
			for o in shots:
				...
				for excluido in shotsClonExcluyendo:
					...
					if mc.shot (excluido, q=1 , startTime =1)==inF and mc.shot (excluido, q=1 , endTime =1)==outF and mc.shot(excluido,q=1,track=1)!=3 and mc.shot(excluido,q=1,track=1)!=mc.shot(o,q=1,track=1):
