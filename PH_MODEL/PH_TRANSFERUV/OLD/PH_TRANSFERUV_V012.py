...
def UIuvTranfer():
    ...
    b1=cmds.button(nameWindow + 'btn1', label="SELECCION", w=50, h=50, command="uvTranferSelect()",bgc=[4,1,1])
    b2=cmds.button(nameWindow + 'btn2',label='TODO EL GRUPO', w=50, h=50, command='UvTranferTodo()',bgc=[2,3,3])
