...
def UIuvTranfer():
    ...
    b1=cmds.button(nameWindow + 'btn1',label='TODO EL GRUPO', command='UvTranferTodo()',bgc=[.3,.3,.4])
    b2=cmds.button(nameWindow + 'btn2', label="SELECCION", command='uvTranferSelect()',bgc=[1,.6,.6])
