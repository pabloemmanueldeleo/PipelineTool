...
def add_light(kind, *args):
    ...
    if kind == 'spot':
        ...
        newName = cmds.rename(lightTrf, str(lightTrf) + '__LSPOSH')
        contSpot=contSpot+1
        ...
        lightTrf = cmds.listRelatives(nameLight)[0]
        newName = cmds.rename(lightTrf, str(lightTrf) + '__LDIRSH')
        contDir=contDir+1
        cmds.parent(newName, 'LIGHTS__GRP')
        refresh()
    elif kind == 'point':
        ...
        lightTrf = cmds.listRelatives(nameLight)[0]
        newName = cmds.rename(lightTrf, str(lightTrf) + '__LPNTSH')
        ...
        lightTrf = cmds.listRelatives(nameLight)[0]
        newName = cmds.rename(lightTrf, str(lightTrf) + '__LAMBSH')
        contAmb=contAmb+1
        cmds.parent(newName, 'LIGHTS__GRP')
        refresh()
    elif kind == 'area':
