...
def add_light(kind=""):
	...
	nombreLuzNueva=cmds.textField ('nombreLuzCreacion' , pht='NOMBRE' , p=col_ventanaCrearLuz ,enterCommand= 'crearLuz(kind)' )
...
def construirScrollsConBotones( emparentarA='') :
	...
	cmds.button ( l = 'TIPO' ,  align = "center" ,  c = ordenarTipo  , en=0,  p = r_00 )
...
def lightListPanel():
	...
	b_filtroArea = cmds.iconTextButton  ('b_filtroLARE',ann='AREA',style='iconOnly',en=0,image1='M:\PH_SCRIPTS\ICONS\LARE_1.png',hi='M:\PH_SCRIPTS\ICONS\LARE_1.png', c = partial(filtrado,"LARE") ,width=25,height=25,p=row_0, dcc=partial(add_light,"area") ,bgc=(0.2,0.2,0.2),font= "fixedWidthFont")
	...
	rowDeColumnas=cmds.rowLayout (nc=2,co2=[175,0],ct2=["left", "left"], p=row_5)
