...
def lightListPanel():
    ...
    try:
        ...
        frame_2 = cmds.frameLayout('frame_2', label='EXTRAS ARNOLD SETTINGS', borderStyle='in', expandCommand= "cmds.frameLayout('frame_2', e=1 , height= cmds.frameLayout('frame_2', q=1 , height= 1)+20 )\ncmds.window('winMLuces', e=1 , height= cmds.window('winMLuces', q=1 , height= 1)+20 )" , collapseCommand = "cmds.frameLayout('frame_2', e=1 , height= cmds.frameLayout('frame_2', q=1 , height= 1)-20 )\ncmds.dockControl('dockLucesUI', e=1 , h=100)"   ,collapsable=1,p=win , h=50 , w=520 )
        ...
        b_domoOnOff = cmds.iconTextButton  ('b_domoOnOff',l='DOMO ON / OFF',style='textOnly',image1='M:\PH_SCRIPTS\ICONS\PH_LUCES_DISP.png', c = domoOnOff,width=90,height=25,p=row_6 ,bgc=(0.4,0.4,0.4))
        refreshOverride()
        enableDropParent()
