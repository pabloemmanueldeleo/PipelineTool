...
def lightListPanel():
	...
	filtrosDropMenu = cmds.optionMenuGrp('oM_filtros',annotation="FILTROS",bgc = [0.7,0.7,0.7],w=150,changeCommand=asignarFiltro,p=row_filtros)
