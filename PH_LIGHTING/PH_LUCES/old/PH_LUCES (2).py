...
def add_light(kind=""):
	...
	nombreLuzNueva=cmds.textField ('nombreLuzCreacion' , pht='NOMBRE' , p=col_ventanaCrearLuz ,enterCommand= partial (crearLuz,kind) )
...
def crearLuz(kind="",*args):
	global nombreLuzNueva
	global winCrearLuz
	nLuz=cmds.textField(nombreLuzNueva,q=1,text=1)
