...
def crearLuz(kind="",primerGrupoCreado='' , nombre=''):
    ...
    for grp in gruposDeLuces:
        if grp !="ROOT_LGRP":
			print ('dockLucesUI|'+grupoVG +'|OptionMenu'), grp
			cmds.menuItem(parent=('dockLucesUI|'+grupoVG +'|OptionMenu'), label=grp[:-5] )
...
def construirScrollsConBotones( emparentarA='') :
	...
	cmds.iconTextButton  (l ='LUZ',ann='LUZ',style='textOnly',image1='M:\PH_SCRIPTS\ICONS\LSPT_1.png', c = ordenarLuz     ,p=r_00 ,bgc=(0.3,0.3,0.3) ,font= "plainLabelFont")
	cmds.iconTextButton (l ='TIPO',ann='TIPO',style='textOnly',image1='M:\PH_SCRIPTS\ICONS\LPNT_1.png', c = ordenarTipo2    ,p=r_00 ,bgc=(0.3,0.3,0.3) ,font= "plainLabelFont")
	cmds.iconTextButton  (l ='GRUPO',ann='GRUPO',style='textOnly',image1='M:\PH_SCRIPTS\ICONS\LARE_1.png', c = ordenarGrupo ,p=r_00 ,bgc=(0.3,0.3,0.3) ,font= "plainLabelFont")
...
def lightListPanel():
	...
	b_flush = cmds.iconTextButton  ('b_flush',l='FLUSH CACHE',style='textOnly',image1='M:\PH_SCRIPTS\ICONS\PH_LUCES_DISP.png', c = "cmds.arnoldFlushCache( textures=True )\ncmds.warning( 'FLUSH')" ,width=90,height=25,p=row_6 ,bgc=(0.4,0.4,0.4))
	refreshOverride()
	enableDropParent()
	cmds.window('winMLuces', e=1 , resizeToFitChildren=1 )
	allowedAreas = ['right', 'left']
	cmds.dockControl( 'dockLucesUI' , label= "PH_LUCES! v1.6 - COMPATIBLE CON ARNOLD -",area='left', content='winMLuces', allowedArea=allowedAreas )
	#cmds.showWindow(win)
