...
def lightListPanel():
    ...
    try:
        ...
        frame_2 = cmds.frameLayout('frame_2', label='EXTRAS ARNOLD SETTINGS', borderStyle='in', expandCommand= expandExtras , collapseCommand = colapseExtras  , collapsable=1,p=win , h=50 , w=520 )
...
def expandExtras(*args):
    cmds.frameLayout ('frame_2', e=1 , height= cmds.frameLayout('frame_2', q=1 , height= 1)+29 )
...
def colapseExtras(*args):
    ...
    cmds.dockControl('dockLucesUI', e=1 , h=100)
    cmds.window('winMLuces', e=1 , resizeToFitChildren=1 )
    cmds.window('winMLuces', e=1 , h=500)
...
def colapseAt(*args):
    ...
    cmds.dockControl('dockLucesUI', e=1 , h=100)
    cmds.window('winMLuces', e=1 , resizeToFitChildren=1 )
    cmds.window('winMLuces', e=1 , h=800)
